                        ...
                        <div class="tab-content" style="background:#b8c2ff" id="myTabContent">
                            ...
                            <div class="tab-pane fade show" id="tabs-icons-text-5" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                                    <h3 class="card-title text-success text-uppercase mb-0">Ing. Prado FC - 7</h3>
                                                    <h3 class="card-title text-white text-uppercase mb-0">VS </h3>
                                                    <h3 class="card-title text-white text-uppercase mb-0">Atlético Fénix - 5</h3>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">Oficial</p>
                                                    <span class="h6 text-yellow font-weight-bold mb-0">Finalizado</span>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="col-xl-3">
                                    <div class="card card-stats bg-danger">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h3 class="card-title text-success text-uppercase mb-0">Tenisticos FC - 5</h3>
                                                    <h3 class="card-title text-white text-uppercase mb-0">VS </h3>
                                                    <h3 class="card-title text-white text-uppercase mb-0">Periodistas FC - 2</h3>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">Amistoso</p>
                                                    <span class="h6 text-yellow font-weight-bold mb-0">Finalizado</span>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="col-xl-3">
                                    <div class="card card-stats bg-danger">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h3 class="card-title text-white text-uppercase mb-0">Vodka Jrs. - 4</h3>
                                                    <h3 class="card-title text-white text-uppercase mb-0">VS </h3>
                                                    <h3 class="card-title text-success text-uppercase mb-0">Natación FC - 7</h3>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">Oficial</p>
                                                    <span class="h6 text-yellow font-weight-bold mb-0">Finalizado</span>
                                                </div>
                                                <div class="col-auto">
                            ...
                            <div class="tab-pane fade show" id="tabs-icons-text-6" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                                    <h3 class="card-title text-uppercase text-success mb-0">Periodistas FC - 5</h3>
                                                    <h3 class="card-title text-uppercase text-white mb-0">VS </h3>
                                                    <h3 class="card-title text-uppercase text-white mb-0">Ing. Prado FC - 3</h3>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">Amistoso</p>
                                                    <span class="h6 text-yellow font-weight-bold mb-0">Finalizado</span>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="col-xl-3">
                                    <div class="card card-stats bg-danger">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h3 class="card-title text-uppercase text-success mb-0">Tenisticos FC - 4</h3>
                                                    <h3 class="card-title text-uppercase text-white mb-0">VS </h3>
                                                    <h3 class="card-title text-uppercase text-white mb-0">Ing. Prado FC - 3 </h3>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">Oficial</p>
                                                    <span class="h6 text-yellow font-weight-bold mb-0">Finalizado</span>
                                ...
                                <div class="col-xl-3">
                                    <div class="card card-stats bg-danger">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h3 class="card-title text-white text-uppercase mb-0">Atlético Fénix - 0</h3>
                                                    <h3 class="card-title text-white  text-uppercase mb-0">VS </h3>
                                                    <h3 class="card-title text-success text-uppercase mb-0">Natación FC - 4</h3>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">Oficial</p>
                                                    <span class="h6 text-yellow font-weight-bold mb-0">Finalizado</span>
                                                </div>
                                                <div class="col-auto">
                            ...
                            <div class="row">
                                <div class="col-xl-3">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                                    <h4 class="card-title text-white text-uppercase mb-0">Tenisticos FC - 1</h4>
                                                    <h4 class="card-title text-white text-uppercase mb-0">VS </h3>
                                                    <h4 class="card-title text-green text-uppercase mb-0">Atlético Fénix - 3</h4>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">Oficial</p>
                                                    <p class="h6 text-yellow font-weight-bold mb-0">Finalizado</p>
                                                </div>
                                                <div class="col-auto">
                                                <div class="icon icon-shape  text-yellow rounded-circle shadow" style="background:#b0021f">
                                                    <i class="fas fa-trophy"></i>
                                ...
                                <div class="col-xl-3">
                                    <div class="card card-stats bg-danger">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h4 class="card-title text-white text-uppercase mb-0">Natación FC - 2</h4>
                                                    <h4 class="card-title text-white text-uppercase mb-0">VS </h4>
                                                    <h4 class="card-title text-green text-uppercase mb-0">Sel. Guadalupe - 3</h4>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">Oficial</p>
                                                    <p class="h6 text-yellow font-weight-bold mb-0">Finalizado</p>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="col-xl-3">
                                    <div class="card card-stats bg-danger">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h4 class="card-title text-green text-uppercase mb-0">Amigos Country - 5</h4>
                                                    <h4 class="card-title text-white text-uppercase mb-0">VS </h4>
                                                    <h4 class="card-title text-white text-uppercase mb-0">Ing. Prado FC - 4</h4>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">Oficial</p>
                                                    <p class="h6 text-yellow font-weight-bold mb-0">Finalizado</p>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="col-xl-3">
                                    <div class="card card-stats bg-danger">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    <h4 class="card-title text-uppercase text-green mb-0">Vodka Jrs. - 2 P(2)</h4>
                                                    <h4 class="card-title text-white text-uppercase mb-0">VS </h4>
                                                    <h4 class="card-title text-white text-uppercase mb-0">Periodistas - 2 P(0)</h4>
                                                    <p class="h6 font-weight-bold text-yellow mb-0">AMISTOSO</p>
                                                    <p class="h6 text-yellow font-weight-bold mb-0">Finalizado</p>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <table class="table align-items-center" style="background:#bae3c5">
                                    ...
                                    <tr class="bg-success">
										 ...
										 <tr class="bg-success">
                                            ...
                                            <th scope="row">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <span class="name mb-0 text-sm">Natación</span>
                                                    </div>
                                                </div>
                                            </th>
                                            <td>
										...
										<tr class="bg-success">
                                            ...
                                            <td>
                                                <span class="status">16</span>
                                            </td>
                                            <td>
                                                <span class="status">14</span>
                                            </td>
                                            <td>
